...
Citizen.CreateThread(function()
  ...
  TriggerEvent('chat:addSuggestion', '/twt', 'Send a Twitter Message', {})
  TriggerEvent('chat:addSuggestion', '/pd', 'Make a PD Announcement', {})
  TriggerEvent('chat:addSuggestion', '/ems', 'Make a EMS Announcement', {})
end)